...
import { Axes, HorizontalDirection, Props, VerticalDirection } from "./types.js";
import { getIgnoreDeclarationList, horizontalDirectionValue, inlinePropTransform, marginPaddingParser, transformToDirectionValue, verticalDirectionValue, } from "./helpers.js";
    ...
    return {
        ...
        Declaration: {
            ...
            [Props.Padding]: (decl) => {
                ...
                const [num, data] = marginPaddingParser(options.hDirection, options.vDirection)(value);
                if (data.left != data.right) {
                    decl.after(new Declaration({
